...
│
├── data/
│   ├── psid_panel_long.csv          # Clean individual-level long panel (output of 1_clean_data.R)
│   └── psid_analysis_ready.csv      # Analysis-ready dataset with constructed variables (output of 2_analysis.R)
│
├── code/
...
├── presentation_script.qmd          # Speaker notes and presentation guide
...
### 2. Place raw data files in the project root
